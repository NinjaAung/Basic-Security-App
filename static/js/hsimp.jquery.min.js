! function e(a, r, o) {
    ...
    18: [function(e, a, r) {
        ...
        var o = e("hsimp-main/bootstrap")(e("hsimp-main")),
            ...
            s = ["hsimp-level--insecure", "hsimp-level--bad", "hsimp-level--ok", "hsimp-level--good"];
        ! function(e) {
            var a = "Time to crack",
                r = function(a) {
                ...
                l = function(e) {
                    e.main && (o.setDictionary(e.main), a = e.main.timeToCrack), e.periods && o.setPeriodDictionary(e.periods), e.namedNumbers && o.setNamedNumberDictionary(e.namedNumbers), e.checks && o.setCheckerDictionary(e.checks)
                },
                c = function(i, l) {
                    var c = e(l);
                    c.addClass("hsimp-level");
                    var d = r(c).hide();
                    c.after(d);
                    var m = e("<p />").addClass("hsimp-results__time"),
                        u = e("<span />"),
                        h = e("<ul />").addClass("hsimp-results__checks");
                    m.append(e("<strong/ >").text(a + ": "), u), d.append(m, h);
                    var g = !1;
                    c.on("keyup", function() {
                        var e = c.val(),
                            a = o(e);
                        e.length ? (g = !0, c.removeClass(s.join(" ")), c.addClass("hsimp-level--" + a.getSecurityLevel()), d.fadeIn(), u.text(a.getString()), h.html(n.map(t, a.getChecks()))) : (g = !1, c.removeClass(s.join(" ")), d.fadeOut(), h.empty())
                    }), c.on("blur", function() {
                        d.fadeOut()
                    }), c.on("focus", function() {
                        g && d.fadeIn()
            ...
            e.fn.hsimp = function(a) {
                o.setOptions(i(a)), a && a.language && l(a.language), e(this).each(c)
            }
        }(jQuery)
    }, {
        "hsimp-library": 10,
